...
MACRO(DETECT_OSG_VERSION)
    ...
    OPTION(OPENSCENEGRAPH_VERSION_APPEND "Append the OSG version number to the osgPlugins directory" ON)

    # detect if osgversion can be found
    FIND_PROGRAM(OSG_VERSION_EXE 
		  NAMES 
				osgversion
		  PATHS
    ...
    IF(OSG_VERSION_EXE)
        ...
        SET(OPENSCENEGRAPH_MAJOR_VERSION "${OPENSCENEGRAPH_MAJOR_VERSION}" )
        SET(OPENSCENEGRAPH_MINOR_VERSION "${OPENSCENEGRAPH_MINOR_VERSION}" )
        SET(OPENSCENEGRAPH_PATCH_VERSION "${OPENSCENEGRAPH_PATCH_VERSION}" )
        SET(OPENSCENEGRAPH_SOVERSION "${OPENSCENEGRAPH_SOVERSION}" )
        SET(OPENSCENEGRAPH_VERSION ${OPENSCENEGRAPH_MAJOR_VERSION}.${OPENSCENEGRAPH_MINOR_VERSION}.${OPENSCENEGRAPH_PATCH_VERSION} CACHE STRING "OSG version detected")
	 ...
	 ELSE (OSG_VERSION_EXE)
        MESSAGE(STATUS "Could not detect OpenSceneGraph version.")	 
    ENDIF(OSG_VERSION_EXE)

    IF (OPENSCENEGRAPH_VERSION_APPEND AND OPENSCENEGRAPH_VERSION)
        SET(OSG_PLUGINS osgPlugins-${OPENSCENEGRAPH_VERSION})
        MESSAGE(STATUS "Plugins will be installed under osgPlugins-${OPENSCENEGRAPH_VERSION} directory.")
    ELSE(OPENSCENEGRAPH_VERSION_APPEND AND OPENSCENEGRAPH_VERSION)
        SET(OSG_PLUGINS osgPlugins)
    ENDIF(OPENSCENEGRAPH_VERSION_APPEND AND OPENSCENEGRAPH_VERSION)
